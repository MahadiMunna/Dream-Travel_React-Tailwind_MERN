...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-black text-white">
            <div>
                <img src={logo} width="150" height="150"  className="inline-block fill-current" alt="" />
                <p className="font-bold text-2xl">Dream Travel Ltd.</p>
                <p>Copyright © 2022 - Dream-Travel.com</p>
            </div>
            <div>
